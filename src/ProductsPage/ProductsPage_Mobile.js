import "./ProductsPage_Mobile.css";
...
function ProductsMobile() {
  return (
    <>
      ...
      <div
        style={{ padding: "4%", position: "relative", height: "100vh" }}
      ...
      <div className="question-back">
        ...
        <div className="simple-text-mobile">Browse our Catalouges</div>
      </div>
      <div className="catalouges-page-mobile">
        <div className="catalouge-card-1-mobile">
          <Row className="catalouge-card-row-mobile gx-0">
            <Col
              span={16}
              style={{ maxWidth: "60%" }}
